...
import com.daijiacong.eduservice.entity.EduCourseDescription;
...
import com.daijiacong.eduservice.mapper.EduCourseMapper;
import com.daijiacong.eduservice.service.EduChapterService;
import com.daijiacong.eduservice.service.EduCourseDescriptionService;
...
public class EduCourseServiceImpl extends ServiceImpl<EduCourseMapper, EduCourse> implements EduCourseService {
    ...
    public String saveCourseInfo(CourseInfoVo courseInfoVo) {
        ...
        if(insert == 0) {
            //添加失败
            throw new JiacongException(20001,"添加课程信息失败");
        }
    ...
    public void updateCourseInfo(CourseInfoVo courseInfoVo) {
        ...
        if(update == 0) {
            throw new JiacongException(20001,"修改课程信息失败");
        }
    ...
    public void removeCourse(String courseId) {
        ...
        if(result == 0) { //失败返回
            throw new JiacongException(20001,"删除失败");
        }
    }
