...
import com.daijiacong.eduservice.mapper.UcenterMemberMapper;
...
public class UcenterMemberServiceImpl extends ServiceImpl<UcenterMemberMapper, UcenterMember> implements UcenterMemberService {
    ...
    public String login(UcenterMember member) {
        ...
        if(StringUtils.isEmpty(mobile) || StringUtils.isEmpty(password)) {
            throw new JiacongException(20001,"登录失败");
        }
    ...
    public void register(RegisterVo registerVo) {
        ...
        if(StringUtils.isEmpty(mobile) || StringUtils.isEmpty(password)
            ...
            throw new JiacongException(20001,"注册失败");
        }
        //判断验证码
        //获取redis验证码
        ...
        member.setAvatar("https://edu-00.oss-cn-shenzhen.aliyuncs.com/2020/05/25/537e0abd13d143128cfb4265bae27fd4file.png");
